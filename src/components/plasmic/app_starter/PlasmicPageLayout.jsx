...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: NyUWjxua06J/css
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: k4wK42bxVzu/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: Cw_erliQSvU/icon
...
function PlasmicPageLayout__RenderFunc(props) {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__xpG5D)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <ph.DataCtxReader>
            {$ctx =>
              true ? (
                <div className={classNames(projectcss.all, sty.freeBox__uEqva)}>
                  <IconIcon
                    className={classNames(projectcss.all, sty.svg___0KfWg)}
                    role={"img"}
                  />
                </div>
              ) : null
      ...
      >
        <ph.DataCtxReader>
          {$ctx =>
            true ? (
              <div className={classNames(projectcss.all, sty.freeBox__nzRsH)}>
                {p.renderPlasmicSlot({
                  defaultContents: (
                    <section
                      className={classNames(projectcss.all, sty.section__a2VAi)}
                    >
                      <h1
                        className={classNames(
                          projectcss.all,
